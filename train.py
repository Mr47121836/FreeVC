...
def run(rank, n_gpus, hps):
  ...
  try:
    _, _, _, epoch_str = utils.load_checkpoint(utils.latest_checkpoint_path("./pretrain_model", "G_*.pth"), net_g, optim_g)
    _, _, _, epoch_str = utils.load_checkpoint(utils.latest_checkpoint_path("./pretrain_model", "D_*.pth"), net_d, optim_d)
